...
terraform init
terraform plan -var="domain=registry.example.com" -var="image_tag=0.8.1"
terraform apply

# Azure
cd deployments/terraform/azure
terraform init
terraform plan -var="location=eastus" -var="image_tag=0.8.1"
terraform apply

# GCP
cd deployments/terraform/gcp
terraform init
terraform plan -var="project_id=my-project" -var="image_tag=0.8.1"
terraform apply
```
